...
exports.downloadPS_view = function(req, res) {
  ...
  "PieSlicerDual.exe application is restricted to the specific computer whose system ID \n"+
  ...
  "  \n"+
  "Clicking on the 'Registration' tab on the opening page of PieSlicer will display both \n"+
  ...
  "based version, then move the PieSlicerDual.exe file to the USB.   Run it there and use \n" +
