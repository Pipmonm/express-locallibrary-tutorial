...
exports.countrytaxauthority_create_post = [
    ...
    body('restriction_code','0:none,1:#transactions,2:total sales, 3:both').isInteger({no_symbols: true, max:3}).withMessage("only codes allowed: 0:none, 1:# trans., 2:$ amnt., 3:both"),
