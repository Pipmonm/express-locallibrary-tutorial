...
debug('This script populates some test books, authors, genres and bookinstances to your database. Specified database as argument - e.g.: populatedb mongodb://your_username:your_password@your_dabase_url');

// Get arguments passed on command line
var userArgs = process.argv.slice(2);
if (!userArgs[0].startsWith('mongodb://')) { //temporary mangling of mongo to enable testing
    debug('ERROR: You truly need to specify a valid mongodb URL as the first argument');
    return
}
...
var mongoDB = userArgs[0]; //for online connection with url
